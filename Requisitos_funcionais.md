...
# Requisitos do Sistema - Escola de Reforço
...
| RF11 | Realizar pagamentos | Permitir que Responsáveis e alunos (acima de 18 anos) realizem pagamentos através do sistema | Baixa |
...
| RNF02 | Performance | Tempo de resposta inferior a 2 segundos | Alta |
| RNF03 | Segurança | Controle de acesso por perfil e proteção de dados | Alta |
| RNF04 | Escalabilidade | Suportar aumento de usuários e dados | Média |
